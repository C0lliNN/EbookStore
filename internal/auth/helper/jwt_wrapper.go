...
func (w JWTWrapper) GenerateTokenForUser(user model.User) (string, error) {
...
func (w JWTWrapper) ExtractUserFromToken(tokenString string) (user model.User, err error) {
