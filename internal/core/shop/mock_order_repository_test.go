...
func (_m *MockOrderRepository) Create(ctx context.Context, order *Order) error {
...
func (_m *MockOrderRepository) FindByID(ctx context.Context, id string) (Order, error) {
...
func (_m *MockOrderRepository) FindByQuery(ctx context.Context, q query.Query, p query.Page) (PaginatedOrders, error) {
